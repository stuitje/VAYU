...
planet = "gj367b"
surface = "greybody"
atmo_types = ["N2_1000ppm_CO2", "N2_1000ppm_SO2", "N2_1000ppm_H2O", "N2_1000ppm_CH4"]
...
gas_labels = {
    "N2_1000ppm_CO2": r"CO$_2$",
    "N2_1000ppm_SO2": r"SO$_2$",
    "N2_1000ppm_H2O": r"H$_2$O",
    "N2_1000ppm_CH4": r"CH$_4$"
}

colors = {
    "N2_1000ppm_CO2": "crimson",
    "N2_1000ppm_SO2": "dodgerblue",
    "N2_1000ppm_H2O": "orange",
    "N2_1000ppm_CH4": "seagreen"
}
...
ax.set_title(f"{planet.upper()}: MIRI emission for N$_2$ + 1000 ppm {gas_label_str} atmospheres (heat redistribution)", fontsize=15)
ax.set_ylim(0.0, 1.3)
...
plt.savefig(os.path.join(out_dir, f"emission_vs_pressure_modes_multiple_gases_N2.pdf"), format = 'pdf', dpi=300)
plt.show()
