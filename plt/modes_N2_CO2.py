...
if __name__ == "__main__":
    ...
    atmospheres = {
        "100bar_N2_1000ppm_CO2": 100,
        "10bar_N2_1000ppm_CO2": 10,
        "1bar_N2_1000ppm_CO2": 1.0,
        "01bar_N2_1000ppm_CO2": 0.1,
        "001bar_N2_1000ppm_CO2": 0.01
    }
    ...
    norm = mcolors.TwoSlopeNorm(vcenter=-3, vmin=-6, vmax=0)
    ...
    ax.set_yscale("log")
    ax.set_title("N$_2$ + 1000 ppm CO$_2$", fontsize=20)
    ...
    plt.tight_layout()
    plot_path = os.path.join(OUTPUT_DIR, planet, f"{planet}_bayes_comparison_plot_N2_CO2.pdf")
